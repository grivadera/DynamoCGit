...
namespace RandomC
{
    internal class SimpleRNG
    {
        ...
        /// </summary>
            ...
            internal void SetSeed(uint u, uint v)
            {
                if (u != 0) m_w = u;
                if (v != 0) m_z = v;
            }

            internal void SetSeed(uint u)
            {
                m_w = u;
            }

            internal void SetSeedFromSystemTime()
            {
            ...
            // Get normal (Gaussian) random sample QQQQS Dwith mean 0 and standard deviation 1
